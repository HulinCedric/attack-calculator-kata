...
{
    [Fact]
    public void Should_not_inflict_damage_when_attack_is_less_or_equal_than_defender_armor_class()
    {
    ...
    [Fact]
    public void Should_inflict_weapon_damage_when_attack_is_greater_than_defender_armor_class()
    {
        // Arrange
        var attacker = new Character(0, 3, "human", 2);
        var defender = new Character(8, 0, "orc", 0);
